      ...
      <div id="profile">
        <div id="center">
          ...
          <div className="profileDiv">
            <img alt="noPic" id="profileImg" src={this.props.profile.profile_pic} onError={(e)=>{e.target.onerror = null; e.target.src="https://www.imsa-search.com/wp-content/uploads/2018/06/avatar.png"}}/>
          </div>
